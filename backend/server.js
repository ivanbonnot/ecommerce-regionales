...
const baseProcces = () => {
    ...
    // Habilita CORS para todas las rutas y orígenes (en desarrollo puedo ajustarlo según tus necesidades)
    app.use(cors());
    ...
    app.use((req, res, next) => {
        const allowedOrigins = [
            'http://localhost:3000',
            'https://apiregionales.ivanbodeveloper.com',
            'https://regionales.ivanbodeveloper.com',
            'http://regionales.ivanbodeveloper.com',
            'http://apiregionales.ivanbodeveloper.com',
        ];
